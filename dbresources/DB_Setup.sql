...
CREATE TABLE empresa_seguridad.persona (
...
CREATE TABLE empresa_seguridad.reporte_turnos (
...
INSERT INTO empresa_seguridad.usuario (nombre_usuario, pass_usuario, id_persona_usuario, id_rol_usuario) VALUES ('vigilante.07', 'vig07', '9', '3');
